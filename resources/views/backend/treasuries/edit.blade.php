    ...
    <div class="col-md-12">
        ...
        <div class="card mb-4">
            <div class="card-header py-3 d-flex justify-content-between">
                <h5 class="m-0 font-weight-bold">تعديل خزنة [<span class="">{{ $treasury->name }}</span>]</h5>
            ...
            <div class="card-body">
                ...
                <form id="formAccountSettings" action="{{ route('backend.treasuries.update', $treasury->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text" id="name"
                                name="name" value="{{ old('name', $treasury->name) }}" autofocus />
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="is_master" id="is_master"
                                ...
                                <option value="1" {{ old('is_master', $treasury->is_master) =='1' ? 'selected' : null
                                    }}>
                                    رئيسية
                                </option>

                                <option value="0" {{ old('is_master', $treasury->is_master)=='0' ? 'selected' : null }}>
                                    فرعية
                                </option>
                            </select>
                            @error('is_master')
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" name="last_receipt_exchange"
                                ...
                                id="last_receipt_exchange"
                                value="{{ old('last_receipt_exchange', $treasury->last_receipt_exchange) }}" />
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" name="last_receipt_collect"
                                ...
                                id="last_receipt_collect"
                                value="{{ old('last_receipt_collect', $treasury->last_receipt_collect) }}" />
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="active" id="active" class="form-select @error('active') is-invalid @enderror">
                                <option value="1" {{ old('active', $treasury->active) =='1' ? 'selected' : null }}>
                                    مفعل
                                </option>

                                <option value="0" {{ old('active', $treasury->active) =='0' ? 'selected' : null }}>
                                    غير مفعل
                                </option>
                            </select>
                            @error('active')
