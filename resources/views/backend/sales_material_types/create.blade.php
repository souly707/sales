    ...
    <div class="col-md-12">
        ...
        <div class="card mb-4">
            <div class="card-header py-3 d-flex justify-content-between">
                <h5 class="m-0 font-weight-bold">انشاء فئة فواتير جديدة</h5>
            ...
            <div class="card-body">
                ...
                <form id="formAccountSettings" action="{{ route('backend.sales_material_types.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="active">حالة الفئة</label>
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ route('backend.sales_material_types.index') }}"
